    ...
    <div class="teamcontent">
      ...
      <div class="inclusiontext">
        <p>
          ...
          accerlerates innovation. We value the unique backgrounds and
          experiences eveeryone brings, and want all who join us to realize
          their full potential. Because different perspectives can fuel the best
          ideas, we are committed to a workplace that is increasingly diverse
          and inclusive.
        </p>
      </div>
      <div class="membertopimage">
        <img src={team_desktop} alt="teams info" />
      </div>
      <div class="membertopimage2">
        <img src={team_mobile} alt="teams info" />
      </div>
      ...
      <div class="teams">
        ...
        <div class="teamsection">
          <p>
            Research product ideas and current fashion trends and see how to
            emulate social issues within the designs themselves, brainstorming
            and design. Develop and manage the TIPTOE& website.
          </p>
        </div>
        <div class="gallery">
